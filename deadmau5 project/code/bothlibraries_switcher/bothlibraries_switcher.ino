// rainbow and sound with switcher pin both libraries
...
int minValue =  800; // min value of msgeq7 for led activation
...
void msgeq7Cycle() {  
    ...
    for(int j=0; j<256*5; j++) { // 5 cycles of all colors on wheel
      ...
      for(int i=0;i<strip.numPixels();i++) {
        ...
        else if( (i==2 | i==9 | i==16 | i==22 | i==27 | i==34 | i==47 | i==52 | i==57 | i==64) & (spectrumValue[0]<breakPoint | minValue>breakPoint) ){
          tempValue = value;
          value = 1;
          isBlink = true;
        }   
        ...
        else if( (i==4 | i==11 | i==18 | i==24 | i==29 | i==36 | i==38 | i==42 | i==44 | i==54 | i==59 | i==66) & (spectrumValue[0]<breakPoint | minValue>breakPoint) ){
          tempValue = value;
          value = 1;
          isBlink = true;
        }
        else if( (i==5 | i==12 | i==19 | i==30 | i==39 | i==48 | i==60 | i==67) & (spectrumValue[1]<breakPoint | minValue>breakPoint) ){
          tempValue = value;
          value = 1;
          isBlink = true;
        }
        else if( (i==6 | i==13 | i==31 | i==40 | i==49 | i==61 | i==68) & (spectrumValue[0]<breakPoint | minValue>breakPoint) ){
          tempValue = value;
          value = 1;
          isBlink = true;
        }    
